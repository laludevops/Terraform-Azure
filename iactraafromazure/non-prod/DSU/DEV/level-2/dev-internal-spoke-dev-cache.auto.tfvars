dev_intranet_redis_cache_name = "redis"

dev_intranet_redis_cache_resource_group_name = "rg-alex-iac"

dev_intranet_redis_cache_location = "southeastasia"

dev_intranet_redis_cache_tags = {
    custom_tag = "Custom tag as needed"
}

dev_intranet_redis_cache_redis_cache = {
    capacity            = 1
    family              = "P" 
    sku_name            = "Premium" 
...
dev_intranet_redis_cache_standard_redis_cache = {
...
dev_intranet_redis_cache_premium_redis_cache = {
...
dev_intranet_redis_cache_firewall_name   = "redisfw"
dev_intranet_redis_cache_start_ip        = "1.0.0.0"
dev_intranet_redis_cache_end_ip          = "1.1.0.0"

dev_intranet_redis_cache_diag_object = {
...
dev_intranet_redis_cache_patch_schedule = {
  day_of_week    = "Monday"
  start_hour_utc = 1
}