...
variable "public_portal_gut_0002_tier_cidr" {}

variable "public_portal_gut_0002_tier_service_endpoints" {
  type    = list(string)
  default = null
}

variable "public_portal_gut_0002_tier_nsg_inbound_rules" {
}

variable "public_portal_gut_0002_tier_nsg_outbound_rules" {
}

variable "public_portal_gut_0002_tier_delegation" {
  default = null
}
