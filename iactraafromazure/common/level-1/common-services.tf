...
#   use_msi             = true
#   tenant_id           = "add common subscritpion tenant id"
#   subscription_id     = "add common subscritpion subscription id"
# }
...
module "azure_backup" {
  ...
  resource_group_name = module.level_1_resource_groups.rg_output.rsv.name
  location            = var.location
  sku                 = "Standard"
...
module "common_azure_key_vault" {
  ...
  resource_group_name = module.level_1_resource_groups.rg_output.kv.name
  location            = var.location
  sku                 = "premium"
  akv_policies = {
    sp1 = {
      object_id          = data.azurerm_client_config.current.client_id //"eee43994-70a9-4667-a7c7-1086f45a6b4a"
  ...
  dependencies = [module.level_1_resource_groups.rg_output.kv]
}

//private dns
# module "private_dns" {
#   source                 = "../../modules/az-terraform-azure-dns-private"
#   resource_group_name    = var.private_dns_resource_group_name
#   dns_zone_name          = var.private_dns_zone_name //"irasgcc.gov.sg"
#   naming_convention_info = local.private_dns_naming_convention_info
#   tags                   = {}
# }
