...
locals {
  resource_group_name = "cmt-21090012"
  vnet_name           = "cmt-21090012-Intranet"
...
data "azurerm_subnet" "example" {
  name                 = "snet-irin-cmnmztmt-0002"
  virtual_network_name = "cmt-21090012-Intranet"
...
module "virtual_machine" {
  ...
  tags                   = {}
  domain_info = {
    active_directory_domain = "irasgcc.gov.sg",
    oupath = "OU=IRASSERVERS,DC=irasgcc,DC=gov,DC=sg",
    active_directory_username = "admin123",
    active_directory_password = "irasgcc@12345"
  }
}
